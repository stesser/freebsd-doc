...
* Wenn Sie nach der _current version_ von FreeBSD suchen, möchten Sie höchstwahrscheinlich eine `RELEASE`-Version (siehe oben) – **nicht** `CURRENT`.

– `CURRENT` hat eine besondere Bedeutung im Entwicklungsprozess.

[[download-rel140]]
=== FreeBSD {rel140-current}-RC1
...
a|
* link:{url-rel}/VM-IMAGES/README.txt[README]
* link:{url-rel}/VM-IMAGES/{rel140-current}-RC1/amd64/Latest/[amd64]
* link:{url-rel}/VM-IMAGES/{rel140-current}-RC1/i386/Latest/[i386]
* link:{url-rel}/VM-IMAGES/{rel140-current}-RC1/aarch64/Latest/[aarch64]
* link:{url-rel}/VM-IMAGES/{rel140-current}-RC1/riscv64/Latest/[riscv64]
